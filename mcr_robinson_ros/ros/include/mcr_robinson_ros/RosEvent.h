...
public:
	...
	EventPortInputROS(std::string topic_name, std::string event_name)
		...
		std::cout << "EventPortOutputROS::EventPortOutputROS(topic, name): advertises: " << topic_name << ", " << event_name << std::endl;
...
public:
	...
	EventPortOutputROS(std::string topic_name, std::string event_name) {
		std::cout << "EventOutputROS::EventOutputROS(topic, name): registered to: " << topic_name << ", " << event_name << std::endl;
		ros::NodeHandle n("~");
		this->topic_name = topic_name;
		this->event_name = event_name;
