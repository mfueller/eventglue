...
template <>
inline std::vector<std::string> MessageConverter<sensor_msgs::JointState, std::vector<std::string> >::convert(
...
template <>
inline sensor_msgs::JointState MessageConverter<std::vector<std::string>, sensor_msgs::JointState>::convert(
